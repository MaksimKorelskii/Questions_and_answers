...
class CreateDoorkeeperTables < ActiveRecord::Migration[6.0]
  def change
    # данные о приложения клиентах, которые будут получать доступ к нашему API
    ...
    # какой пользователь, какому приложению, какие права предоставил
    ...
    # хранит токены доступа пользователя и приложения
